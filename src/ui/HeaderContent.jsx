  ...
  return (
    <section className='header__content'>
      <div className="img__container">
        <img src={Me} alt="" />
        <p className='p__fullStack'>Front-End<br/>Developer</p>
      </div>
      <div className="header__aboutMe">
        <h1>Soy <br/><span>Alexis Medrano</span></h1>
        <h3>Desarrollador Frontend Jr</h3>
        <div className="header__social">
            <a href="https://www.linkedin.com/in/alan-alexis-medrano-gomez-4431b4218/" target='_blank'><i className='bx bxl-linkedin'></i></a>
